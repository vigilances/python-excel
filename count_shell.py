...
book = xlrd.open_workbook("files.xls")
...
for overtime in is_overtime:
    detail_i+=1
    count_money+=30*int(is_overtime[overtime])
    ...
    sheet_count.write(2+detail_i,2,30,style)
    sheet_count.write(2+detail_i,3,30*int(is_overtime[overtime]),style)
sheet_count.write_merge(3+detail_i,3+detail_i,1,1,count_time,style)
sheet_count.write_merge(3+detail_i,3+detail_i,2,2,"30",style)
